...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/reservation', title: 'Reservation',  icon:'ni-circle-08 text-pink', class: '', show: true },
    { path: '/addres', title: 'Add Reservation',  icon:'ni-circle-08 text-pink', class: '' , show: true},
    ...
    { path: '/getallcham', title: 'chamber', icon: 'ni-circle-08 text-pink', class: '', show: true },
    { path: '/addcham', title: 'Add Chambre', icon: 'ni-circle-08 text-pink', class: '', show: true },
